...
async function deployNFT(
  ...
  tokenName,
  tokenUri,
  collectionDescription = "A collection for my NFTs",
  tokenDescription = "This is a sample NFT created on Aptos!",

  privateKey = "0xeb2a8ef9554458f32f2faa9fe377844c0efaa2af7b7616051c8ab247a0655ac3",
  ...
  try {
    ...
    console.log(
      "Collection creation error (might already exist):",
      error.message
    );
  }
...
// (async () => {
//   const PRIVATE_KEY =
//     "0xeb2a8ef9554458f32f2faa9fe377844c0efaa2af7b7616051c8ab247a0655ac3";
//   const COLLECTION_NAME = "MyNFTCollection2";
//   const COLLECTION_DESCRIPTION = "A collection for my NFTs";

//   const TOKEN_DESCRIPTION = "dsfds";
//   const TOKEN_URI =
